...
async function downloadFile(url, outputPath, onProgress) {
  ...
  console.log(`[Download] URL: ${cleanedUrl.substring(0, 100)}...`);
  ...
  console.log(`[Download] Size: ${(totalSize / 1024 / 1024).toFixed(1)} MB`);
  ...
  return new Promise((resolve, reject) => {
    writer.on('finish', () => {
      console.log(`[Download] Complete: ${outputPath} (${(downloaded / 1024 / 1024).toFixed(1)} MB)`);
